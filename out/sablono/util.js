...
var x__25596__auto__ = (((x == null))?null:x);
var m__25597__auto__ = (sablono.util.to_str[goog.typeOf(x__25596__auto__)]);
if(!((m__25597__auto__ == null))){
return m__25597__auto__.call(null,x);
} else {
var m__25597__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25597__auto____$1 == null))){
return m__25597__auto____$1.call(null,x);
} else {
...
var x__25596__auto__ = (((x == null))?null:x);
var m__25597__auto__ = (sablono.util.to_uri[goog.typeOf(x__25596__auto__)]);
if(!((m__25597__auto__ == null))){
return m__25597__auto__.call(null,x);
} else {
var m__25597__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25597__auto____$1 == null))){
return m__25597__auto____$1.call(null,x);
} else {
...
var len__25999__auto___28539 = arguments.length;
var i__26000__auto___28540 = (0);
while(true){
if((i__26000__auto___28540 < len__25999__auto___28539)){
args__26006__auto__.push((arguments[i__26000__auto___28540]));

var G__28541 = (i__26000__auto___28540 + (1));
i__26000__auto___28540 = G__28541;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__26007__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq28538){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28538));
});
/**
...
var vec__28543 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__28543,(0),null);
var words = cljs.core.nthnext.call(null,vec__28543,(1));
...
var G__28545 = clojure.set.rename_keys.call(null,m,kmap);
var G__28545__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__28545,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__28545);
return G__28545__$1;
} else {
return m;
}
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24941__auto__ = x__$1.hasDomain();
