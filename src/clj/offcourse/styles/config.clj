...
(def graph
  {:colors            (fnk [] {:black      "#000000"
   ...
   :base-unit         (fnk [] (px 30))
   :card-width        (fnk [base-unit] (* 14 base-unit))
   :base-border       (fnk [base-unit colors]
                           [[(/ base-unit 30) :solid (:black colors)]])
   :base-color-dark   (fnk [colors] (:black colors))
   :base-color-medium (fnk [colors] (:lightgray colors))
   :base-color-light  (fnk [colors] (:white colors))
