...
(defmethod to-url :collection-view [{:keys [type dependencies] :as vm} routes]
  (let [{:keys [collection-type collection-name]} (:collection dependencies)]
